 ...
 *
 */
public class TutorialBlockFurnace extends ContainerBlock
{
    public TutorialBlockFurnace()
    {
        super(Block.Properties.create(Material.ROCK).setLightLevel(TutorialBlockFurnace::getLightValue)
        );
    ...
    public ActionResultType onBlockActivated(BlockState state, World worldIn, BlockPos pos, PlayerEntity player, Hand hand, BlockRayTraceResult rayTraceResult) {
        ...
        if (namedContainerProvider != null) {
            ...
            if(namedContainerProvider instanceof TileEntityFurnace){
                ((TileEntityFurnace) namedContainerProvider).grantStoredRecipeExperience(worldIn, Vector3d.copyCentered(pos));
            }
    ...
    public void onReplaced(BlockState state, World world, BlockPos blockPos, BlockState newState, boolean isMoving) {
        if (state.getBlock() != newState.getBlock()) {
            ...
            if (tileentity instanceof TileEntityFurnace) {
                ...
                ((TileEntityFurnace)tileentity).grantStoredRecipeExperience(world, Vector3d.copyCentered(blockPos));
            }

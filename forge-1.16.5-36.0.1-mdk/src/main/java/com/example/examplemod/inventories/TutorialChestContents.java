package com.example.examplemod.inventories;
...
public class TutorialChestContents implements IInventory {
     ...
     */
    public static TutorialChestContents createForTileEntity(int size,
                                                            Predicate<PlayerEntity> canPlayerAccessInventoryLambda,
                                                            Notify markDirtyNotificationLambda) {
        return new TutorialChestContents(size, canPlayerAccessInventoryLambda, markDirtyNotificationLambda);
    }
     ...
     * @return the new ChestContents
     */
    public static TutorialChestContents createForClientSideContainer(int size) {
        return new TutorialChestContents(size);
    }
    ...
    private TutorialChestContents(int size) {
        this.chestContents = new ItemStackHandler(size);
    }

    private TutorialChestContents(int size, Predicate<PlayerEntity> canPlayerAccessInventoryLambda, Notify markDirtyNotificationLambda) {
        this.chestContents = new ItemStackHandler(size);
        this.canPlayerAccessInventoryLambda = canPlayerAccessInventoryLambda;
        this.markDirtyNotificationLambda = markDirtyNotificationLambda;
    }

...
public class ContainerWorkbench extends Container {
    ...
    public ContainerWorkbench(int id, PlayerInventory playerInventory) {
        this(id, playerInventory, IWorldPosCallable.DUMMY);
    }

    public ContainerWorkbench(int id, PlayerInventory playerInventory, IWorldPosCallable p_i50090_3_) {
        super(ModTiles.TUTORIAL_WORKBENCH.get(), id);
        ...
        ExampleMod.LOGGER.info("crafting table created");
    ...
    public boolean canInteractWith(PlayerEntity playerIn) {
        //MUST CHANGE BLOCK WHEN CREATING NEW BLOCK OR WILL DISPLAY FOR 1 FRAME AND CLOSE
        return isWithinUsableDistance(this.worldPosCallable, playerIn, ModBlocks.CRAFTING_BLOCK.get());
    }

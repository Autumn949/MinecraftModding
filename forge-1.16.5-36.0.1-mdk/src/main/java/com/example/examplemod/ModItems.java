...
public class ModItems {
    ...
    public static final RegistryObject<Item> TUTORIAL_BACKPACK = Registration.ITEMS.register("tutorial_backpack", ()-> new TutorialBackpack(TutorialArmorMaterial.TUTORIAL_ARMOR_MATERIAL,EquipmentSlotType.CHEST, new Item.Properties().group(ItemGroup.TOOLS)));
    //ToolItem

...
public class TutorialTileEntity extends TileEntity implements INamedContainerProvider {
    public static final int NUMBER_OF_SLOTS = 36;

    public TutorialTileEntity()
    {
        super(ModTiles.TUTORIAL_TILE_ENTITY.get());
        chestContents = TutorialChestContents.createForTileEntity(NUMBER_OF_SLOTS,
    ...
    public ITextComponent getDisplayName() {
        return new TranslationTextComponent("Tutorial Chest");
    }
    ...
    private final TutorialChestContents chestContents; // holds the ItemStacks in the Chest
}

...
public class ExampleRecipe implements IExampleRecipe {
    ...
    public ExampleRecipe(ResourceLocation idIn, String groupIn, int recipeWidthIn, int recipeHeightIn, NonNullList<Ingredient> recipeItemsIn, ItemStack recipeOutputIn) {
        this.id = idIn;
        this.group = groupIn;
    ...
    public IRecipeSerializer<?> getSerializer() {
        return ModRecipes.EXAMPLE_SERIALIZER.get();
    }
    ...
    public static class Serializer extends net.minecraftforge.registries.ForgeRegistryEntry<IRecipeSerializer<?>>  implements IRecipeSerializer<ExampleRecipe> {
        ...
        public ExampleRecipe read(ResourceLocation recipeId, JsonObject json) {
            ...
            String[] astring = ExampleRecipe.shrink(ExampleRecipe.patternFromJson(JSONUtils.getJsonArray(json, "pattern")));
